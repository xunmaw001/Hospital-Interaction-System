...
//                            yishengEntity.setYishengPhone(data.get(0));                    //手机号 要改的
//                            yishengEntity.setKeshiTypes(Integer.valueOf(data.get(0)));   //科室 要改的
//                            yishengEntity.setYishengZhuanchang(data.get(0));                    //擅长领域 要改的
//                            yishengEntity.setYishengZhicheng(data.get(0));                    //职称 要改的
//                            yishengEntity.setYishengPhoto("");//照片
//                            yishengEntity.setYishengZuozhenshijian(data.get(0));                    //坐诊时间 要改的
