        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="手机号" prop="yishengPhone">
                       <el-input v-model="ruleForm.yishengPhone"
                                 placeholder="手机号" clearable  :readonly="ro.yishengPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="擅长领域" prop="yishengZhuanchang">
                       <el-input v-model="ruleForm.yishengZhuanchang"
                                 placeholder="擅长领域" clearable  :readonly="ro.yishengZhuanchang"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="职称" prop="yishengZhicheng">
                       <el-input v-model="ruleForm.yishengZhicheng"
                                 placeholder="职称" clearable  :readonly="ro.yishengZhicheng"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="坐诊时间" prop="yishengZuozhenshijian">
                       <el-input v-model="ruleForm.yishengZuozhenshijian"
                                 placeholder="坐诊时间" clearable  :readonly="ro.yishengZuozhenshijian"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="个人介绍" prop="yishengContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yishengContent" label="个人介绍" prop="yishengContent">
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    yishengPhone: false,
                    keshiTypes: false,
                    yishengZhuanchang: false,
                    yishengZhicheng: false,
                    yishengPhoto: false,
                    yishengZuozhenshijian: false,
