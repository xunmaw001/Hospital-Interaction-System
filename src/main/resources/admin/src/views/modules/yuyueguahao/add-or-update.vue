    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="账户" prop="username">
                        <el-input v-model="yishengForm.username"
                                  placeholder="账户" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="密码" prop="password">
                        <el-input v-model="yishengForm.password"
                                  placeholder="密码" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="性别" prop="sexValue">
                        <el-input v-model="yishengForm.sexValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="擅长领域" prop="yishengZhuanchang">
                        <el-input v-model="yishengForm.yishengZhuanchang"
                                  placeholder="擅长领域" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="擅长领域" prop="yishengZhuanchang">
                            <el-input v-model="ruleForm.yishengZhuanchang"
                                      placeholder="擅长领域" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="职称" prop="yishengZhicheng">
                        <el-input v-model="yishengForm.yishengZhicheng"
                                  placeholder="职称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="职称" prop="yishengZhicheng">
                            <el-input v-model="ruleForm.yishengZhicheng"
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="坐诊时间" prop="yishengZuozhenshijian">
                        <el-input v-model="yishengForm.yishengZuozhenshijian"
                                  placeholder="坐诊时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="坐诊时间" prop="yishengZuozhenshijian">
                            <el-input v-model="ruleForm.yishengZuozhenshijian"
            ...
            <input id="yishengId" name="yishengId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约内容" prop="yuyueneirongText">
                        <el-input type="textarea"  :readonly="ro.yuyueneirongText" v-model="ruleForm.yuyueneirongText" placeholder="预约内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yuyueneirongText" label="预约内容" prop="yuyueneirongText">
                            <span v-html="ruleForm.yuyueneirongText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="预约时间" prop="yuyueneirongTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.yuyueneirongTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.yuyueneirongTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yuyueneirongTime" label="预约时间" prop="yuyueneirongTime">
                            <span v-html="ruleForm.yuyueneirongTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yishengId: false,
                    yuyueneirongText: false,
                    yuyueneirongTime: false,
                    yonghuId: false,
                    yuyueguahaoYesnoTypes: false,
                    yuyueguahaoYesnoText: false,
                },
                ruleForm: {
                    yishengId: '',
                    yuyueneirongText: '',
                    yuyueneirongTime: '',
                    yonghuId: '',
                    yuyueguahaoYesnoTypes: '',
                    yuyueguahaoYesnoText: '',
                },
                yuyueguahaoYesnoTypesOptions : [],
                yishengOptions : [],
                yonghuOptions : [],
                rules: {
                   yishengId: [
                   ...
                   yuyueneirongText: [
                              { required: true, message: '预约内容不能为空', trigger: 'blur' },
                          ],
                   yuyueneirongTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yuyueguahao_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yuyueguahaoYesnoTypesOptions = data.data.list;
                    }
                });
