    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医嘱编号" prop="yizhuUuidNumber">
                       <el-input v-model="ruleForm.yizhuUuidNumber"
                                 placeholder="医嘱编号" clearable  :readonly="ro.yizhuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="医嘱编号" prop="yizhuUuidNumber">
                           <el-input v-model="ruleForm.yizhuUuidNumber"
                                     placeholder="医嘱编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医嘱标题" prop="yizhuName">
                       <el-input v-model="ruleForm.yizhuName"
                                 placeholder="医嘱标题" clearable  :readonly="ro.yizhuName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="医嘱标题" prop="yizhuName">
                           <el-input v-model="ruleForm.yizhuName"
                                     placeholder="医嘱标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="注意事项" prop="yizhuZhuyishixiang">
                       <el-input v-model="ruleForm.yizhuZhuyishixiang"
                                 placeholder="注意事项" clearable  :readonly="ro.yizhuZhuyishixiang"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="注意事项" prop="yizhuZhuyishixiang">
                           <el-input v-model="ruleForm.yizhuZhuyishixiang"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="忌口" prop="yizhuJikou">
                       <el-input v-model="ruleForm.yizhuJikou"
                                 placeholder="忌口" clearable  :readonly="ro.yizhuJikou"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="忌口" prop="yizhuJikou">
                           <el-input v-model="ruleForm.yizhuJikou"
                                     placeholder="忌口" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    yizhuUuidNumber: false,
                    yizhuName: false,
                    yonghuId: false,
                    yizhuZhuyishixiang: false,
                    yizhuJikou: false,
                    yizhuTime: false,
                },
                ruleForm: {
                    yizhuUuidNumber: new Date().getTime(),
                    yizhuName: '',
                    yonghuId: '',
                    yizhuZhuyishixiang: '',
                    yizhuJikou: '',
                ...
                rules: {
                   yizhuUuidNumber: [
                              { required: true, message: '医嘱编号不能为空', trigger: 'blur' },
                          ],
                   yizhuName: [
                              { required: true, message: '医嘱标题不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
                   ...
                   yizhuJikou: [
                              { required: true, message: '忌口不能为空', trigger: 'blur' },
                          ],
                   yizhuTime: [
