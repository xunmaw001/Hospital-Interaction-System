  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='擅长领域' prop="yishengZhuanchang">
               <el-input v-model="ruleForm.yishengZhuanchang"  placeholder='擅长领域' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='职称' prop="yishengZhicheng">
               <el-input v-model="ruleForm.yishengZhicheng"  placeholder='职称' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='坐诊时间' prop="yishengZuozhenshijian">
               <el-input v-model="ruleForm.yishengZuozhenshijian"  placeholder='坐诊时间' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='yisheng'"  label="个人介绍" prop="yishengContent">
                 <editor
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yishengZhuanchang)&& 'yisheng'==this.flag){
                             this.$message.error('擅长领域不能为空');
                             return
                         }

                         if((!this.ruleForm.yishengZhicheng)&& 'yisheng'==this.flag){
                         ...
                         if((!this.ruleForm.yishengZuozhenshijian)&& 'yisheng'==this.flag){
                             this.$message.error('坐诊时间不能为空');
                             return
                         }

                         if((!this.ruleForm.yishengContent)&& 'yisheng'==this.flag){
                             this.$message.error('个人介绍不能为空');
                             return
                         }
